                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="media align-items-center mb-3">
                                <img class="mr-1" src="{{asset('assets/'. Auth::user()->userable->thumbnail)}}" width="80" height="80" alt="">
                    ...
                    <div class="card-body">
                        @foreach (Auth::user()->userable->post as $post)
                            <div class="media media-reply">
                                <img class="mr-3 circle-rounded" src="{{asset('assets/'.$post->owner->thumbnail)}}" width="50" height="50">
                                <div class="media-body">
